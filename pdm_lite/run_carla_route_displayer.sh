...
export SCRIPT="/home/ste/Documents/DriveLM/pdm_lite/leaderboard/scripts/route_displayer.py"
export ROUTE_ID=0
poetry run python ${SCRIPT} --host='localhost' --port=${PORT} -sa -ss --f ${ROUTES}
